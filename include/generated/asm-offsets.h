...
#define TASK_threadsp 5336 /* offsetof(struct task_struct, thread.sp) */
#define TASK_stack_canary 2440 /* offsetof(struct task_struct, stack_canary) */
...
#define VMX_spec_ctrl 9064 /* offsetof(struct vcpu_vmx, spec_ctrl) */
